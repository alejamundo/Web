...
console.log(redondearNumero(9.3));
function redondearHaciaArriba(num) {
  // Redondea "num" hacia arriba (al próximo entero) y devuélvelo
  // Tu código:
  return Math.round()
}
console.log(redondearHaciaArriba(9.5));
...
console.log(combinarNombres("Alejandra","orrego"));
...
function esVocal(letra){
 ...
 if(letra=='a'||letra=='e'||letra=='i'||letra=='o'||letra=='u'){
    ...
    return "Dato incorrecto solo es un caracter"
  }else{
